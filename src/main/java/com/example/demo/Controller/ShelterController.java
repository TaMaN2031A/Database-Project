...
public class ShelterController {
    ...
    @GetMapping("/name/{staffUserName}")
    public int getShelterNameByStaffUserName(@PathVariable String staffUserName){
        System.out.println(shelterService.getShelterNameByStaffUserName(staffUserName));
        return  shelterService.getShelterNameByStaffUserName(staffUserName);
    }
