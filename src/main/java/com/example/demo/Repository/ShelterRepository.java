...
public class ShelterRepository {
    ...
    public String getShelterNameById(int shelterId) {
        String sql = "SELECT name FROM shelter WHERE id = ?";
        return jdbcTemplate.queryForObject(sql, String.class, shelterId);
    }
    public String getShelterLocationById(int shelterId) {
        String sql = "SELECT location FROM shelter WHERE id = ?";
        return jdbcTemplate.queryForObject(sql, String.class, shelterId);
    }
